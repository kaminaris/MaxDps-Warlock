...
function Destruction:cleave()
    ...
    if (MaxDps:CheckSpellUsable(classtable.Wither, 'Wither')) and (not talents[classtable.InternalCombustion] and ( ( ( debuff[classtable.WitherDeBuff].remains - 5 * ( (classtable and classtable.ChaosBolt and cooldown[classtable.ChaosBolt].duration - cooldown[classtable.ChaosBolt].remains <=2 ) and 1 or 0) ) <debuff[classtable.WitherDeBuff].duration * 0.3 ) or debuff[classtable.WitherDeBuff].remains <3 ) and ( not talents[classtable.SoulFire] or cooldown[classtable.SoulFire].remains + ( classtable and classtable.SoulFire and GetSpellInfo(classtable.SoulFire).castTime / 1000 ) >( debuff[classtable.WitherDeBuff].remains ) ) and ttd >8 and not (classtable and classtable.SoulFire and cooldown[classtable.SoulFire].duration - cooldown[classtable.SoulFire].remains <=2 )) and cooldown[classtable.Wither].ready then
        if not setSpell then setSpell = classtable.Wither end
    end
...
function Destruction:callaction()
    ...
    if (MaxDps:CheckSpellUsable(classtable.Wither, 'Wither')) and (not talents[classtable.InternalCombustion] and ( ( ( debuff[classtable.WitherDeBuff].remains - 5 * ( (classtable and classtable.ChaosBolt and cooldown[classtable.ChaosBolt].duration - cooldown[classtable.ChaosBolt].remains <=2 ) and 1 or 0) ) <debuff[classtable.WitherDeBuff].duration * 0.3 ) or debuff[classtable.WitherDeBuff].remains <3 ) and ( not talents[classtable.Cataclysm] or cooldown[classtable.Cataclysm].remains >debuff[classtable.WitherDeBuff].remains ) and ( not talents[classtable.SoulFire] or cooldown[classtable.SoulFire].remains + ( classtable and classtable.SoulFire and GetSpellInfo(classtable.SoulFire).castTime / 1000 ) >( debuff[classtable.WitherDeBuff].remains ) ) and ttd >8 and not (classtable and classtable.SoulFire and cooldown[classtable.SoulFire].duration - cooldown[classtable.SoulFire].remains <=2 )) and cooldown[classtable.Wither].ready then
        if not setSpell then setSpell = classtable.Wither end
    end
